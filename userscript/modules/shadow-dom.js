(function() {
    return {
        createControlPanel: function() {
            ...
            // Event listeners
            $("toggle-run").addEventListener("click", function() {
                console.log("Toggle run clicked");
            });
            ...
            $("wager-input").addEventListener("change", (e) => {
                console.log("Wager changed:", e.target.value);
            });
            $("hands-input").addEventListener("change", (e) => {
                console.log("Hands changed:", e.target.value);
            });
